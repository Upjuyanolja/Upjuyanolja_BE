...
INSERT INTO `address` (`id`, `address`, `detail_address`)
VALUES (1, '경기도 양평군 용문면 용문산로 337', ''),
       (2, '경상남도 김해시 대동면 대동로 536-15', ''),
       (3, '경상남도 거제시 일운면 거제대로 1988-10', ''),
       (4, '강원특별자치도 평창군 용평면 태기로 1034', '(백옥포리)'),
       (5, '전라남도 구례군 용방면 용산로 107-66', ''),
       (6, '경기도 양평군 강상면 독배길 34', ''),
       (7, '서울특별시 강남구 테헤란로 521', ''),
       (8, '제주특별자치도 제주시 노형동', '');
