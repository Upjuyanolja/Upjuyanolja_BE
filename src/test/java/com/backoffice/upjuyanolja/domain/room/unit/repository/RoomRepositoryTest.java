...
public class RoomRepositoryTest {
    ...
    @Nested
    @DisplayName("findAllByAccommodationId()는")
    class Context_findAllByAccommodationId {

        @Test
        @DisplayName("객실 목록을 페이지네이션하여 조회할 수 있다.")
        void page_willSuccess() {
            // given
            Accommodation accommodation = saveAccommodation();
            saveRoom(accommodation);

            // when
            Page<Room> result = roomRepository.findAllByAccommodationId(1L,
        ...
        void list_willSuccess() {
            // given
            Accommodation accommodation = saveAccommodation();
            saveRoom(accommodation);

            // when
            List<Room> result = roomRepository.findAllByAccommodationId(1L);
    ...
    @Nested
    @DisplayName("countByAccommodation()는")
    class Context_countByAccommodation {
        ...
        void _willSuccess() {
            ...
            // when
            long result = roomRepository.countByAccommodationId(1L);
