...
public enum ErrorCode {
    ...
    ACCOMMODATION_OPTION_NOT_FOUND(HttpStatus.NOT_FOUND, 2001, "숙소 옵션 정보를 찾을 수 없습니다."),
    RESERVATION_NOT_POSSIBLE(HttpStatus.BAD_REQUEST, 2002, "예약이 불가능한 방입니다."),
    WRONG_CATEGORY(HttpStatus.BAD_REQUEST, 2003, "알맞지 않은 카테고리입니다."),
    ACCOMMODATION_IMAGE_NOT_EXISTS(HttpStatus.BAD_REQUEST, 2004, "숙소 이미지를 1개 이상 등록해야 합니다."),
    FAILED_SAVE_IMAGE(HttpStatus.BAD_REQUEST, 2005, "이미지 저장에 실패했습니다."),
    ...
    ROOM_PRICE_NOT_FOUND(HttpStatus.NOT_FOUND, 3002, "객실 가격 정보를 찾을 수 없습니다."),
    DUPLICATED_ROOM_NAME(HttpStatus.BAD_REQUEST, 3003, "중복된 객실 이름입니다."),
    INVALID_TIME_FORMAT(HttpStatus.BAD_REQUEST, 3004, "올바르지 않은 형식의 시간입니다.(HH:mm)"),
    INVALID_ROOM_STATUS(HttpStatus.BAD_REQUEST, 3005, "올바르지 않은 형식의 객실 상태입니다."),
    ROOM_STOCK_NOT_FOUND(HttpStatus.NOT_FOUND, 3006, "객실 재고 정보를 찾을 수 없습니다."),
    ROOM_IMAGE_NOT_FOUND(HttpStatus.NOT_FOUND, 3007, "객실 이미지 정보를 찾을 수 없습니다."),
    ROOM_NOT_EXISTS(HttpStatus.BAD_REQUEST, 3008, "객실을 1개 이상 등록해야 합니다."),
    ROOM_IMAGE_NOT_EXISTS(HttpStatus.BAD_REQUEST, 3009, "객실 이미지를 1개 이상 등록해야 합니다."),
    LAST_ROOM(HttpStatus.BAD_REQUEST, 3010, "마지막 객실은 삭제할 수 없습니다."),
